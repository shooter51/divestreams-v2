...
/**
 * Course detail hero image with fallback for broken/hotlinked images
 */
function CourseDetailImage({ images, name }: { images: string[] | null; name: string }) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            {/* Course Image */}
            <CourseDetailImage images={course.images} name={course.name} />
