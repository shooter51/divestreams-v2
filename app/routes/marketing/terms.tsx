...
export const meta: MetaFunction<typeof loader> = ({ data }) => [
  { title: `Terms of Service - ${data?.orgName ?? "DiveStreams"}` },
  { name: "description", content: "Terms of service and user agreement" },
];
    ...
    <div className="min-h-screen bg-surface">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <article className="prose prose-slate max-w-none">
          <h1 className="text-4xl font-bold mb-2">{orgName ? `${orgName} — ` : ""}Terms of Service</h1>
