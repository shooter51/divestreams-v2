 ...
 *
 * Collects student details and creates enrollment.
 */
...
export async function action({ params, request }: ActionFunctionArgs) {
  ...
  // Verify course is still available
  const course = await getPublicCourseById(org.id, courseId);
  if (!course) {
    errors.form = "This course is no longer available";
  }
            ...
            <p className="text-xs text-gray-500 text-center">
              ...
              {course.depositAmount && (
                <>
                  {" "}
                  A deposit of{" "}
                  {formatPrice(course.depositAmount, course.currency)} will be
            ...
            <div className="text-sm text-gray-600 mt-3 space-y-1">
              ...
              {course.minOpenWaterDives > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  {course.minOpenWaterDives} open water dive
